...
public class StaffService implements IStaffService {
	...
	@Override
	/*public void modify(String name,String account,String phone,String email,int typeid,int sid) {
		staffMapper.update(name,account, phone,email,typeid,sid);
	}*/
	...
	@Override
	public Staff queryLastInsert() {
		return staffMapper.queryLastInsert();
	}
